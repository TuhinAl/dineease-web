...
import { OTPCompService } from "./OTPCompService";

@Component({
  selector: 'OTPComp',
  templateUrl: './OTPComp.html',
  styleUrls: ['./OTPComp.scss']
})
export class OTPComp implements OnInit {


  userRequestFg: FormGroup = this.formService.makeBlankForm(UserRequest);

  constructor(private formService: FormService,
    private otpCompService: OTPCompService,
  ...
  login() {
    this.otpCompService.login(this.userRequestFg)
